...
public class girl {
	...
	public String r; // To check if girl was earlier committed.
	/**
	* Constructor to initialize the attributes.
	*/
	girl(String name,int intelligence,int attractiveness,int maintenance,String st,String s,String r) {
		this.name = name;
