...
public class testing_utility {
	...
	public static girl Girls[] = new girl[10]; // Array of type girl.
	public static boy Boys[] = new boy[60];	// Array of type boy.
	public static gift Gifts[] = new gift[40]; // Array of type gift.
	...
	*/
	...
	int z; // Auxiliary variable.
	boy b; // Reference variable of type boy.
	for(int i=0;i<60;i++) {
		Random r = new Random();
		z = r.nextInt(3);
		if(z == 0) {
	...
	*/
	...
	int z; // Auxiliary variable.
	girl g; // Reference variable of type girl.
	for(int i=0;i<10;i++) {
		Random r = new Random();
		z = r.nextInt(3);
		if(z == 0) {
	...
	*/
	...
	int z; // Auxiliary variable.
	gift g; // Reference variable of type gift.
	for(int i=0;i<40;i++) {
		Random r = new Random();
		z = r.nextInt(3);
		if(z == 0) {
